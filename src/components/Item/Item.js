...
const Item = () => {
    ...
    return (
        <div className='p-5'>
            <h1 className='text-center text-4xl text-orange-600 font-bold'> Food Details </h1>
            <div className='grid grid-cols-2 justify-center justify-items-center p-10 border shadow-lg'>
                ...
                <div>
                    <img className='h-auto max-w-sm rounded-lg' src={meal[0]?.strMealThumb} alt="" />
                </div>
            </div>
        </div>
    );
